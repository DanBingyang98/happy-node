...
import com.danby.happynode.distributed.id.generator.biz.core.common.*;
import com.danby.happynode.distributed.id.generator.biz.core.snowflake.exception.CheckLastTimeException;
...
public class SnowflakeZookeeperHolder {
    ...
    public boolean init() {
        try {
            CuratorFramework curator = createWithOptions(connectionString, new RetryUntilElapsed(1000, 4), 10000, 60000);
            curator.start();
