...
public class LikeUnlikeComment2DBConsumer {
    ...
    public DefaultMQPushConsumer mqPushConsumer() throws MQClientException {
        // Group 组
        String group = "happynode_group_" + MQConstants.TOPIC_COMMENT_LIKE_OR_UNLIKE;
    ...
    private void executeBatchSQL(ArrayList<LikeUnlikeCommentMqDTO> finalLikeUnlikeCommentMqDTOS) {
        List<LikeUnlikeCommentMqDTO> likes = finalLikeUnlikeCommentMqDTOS.stream()
                .filter(ops -> Objects.equals(ops.getType(), LikeUnlikeCommentTypeEnum.LIKE.getCode()))
                .toList();

        List<LikeUnlikeCommentMqDTO> unlikes = finalLikeUnlikeCommentMqDTOS.stream()
                .filter(ops -> Objects.equals(ops.getType(), LikeUnlikeCommentTypeEnum.UNLIKE.getCode()))
                .toList();
