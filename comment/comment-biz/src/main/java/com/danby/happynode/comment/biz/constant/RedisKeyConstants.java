package com.danby.happynode.comment.biz.constant;

public class RedisKeyConstants {

    /**
     * Key 前缀：一级评论的 first_reply_comment_id 字段值是否更新标识 一级评论下的第一条二级回复评论
     */
     ...
     * 评论维度计数 Key 前缀
     */
    public static final String COUNT_COMMENT_KEY_PREFIX = "count:comment:";
     ...
     * @return
     */
    public static String buildCountCommentTotalKey(Long noteId) {
