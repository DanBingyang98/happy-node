...
import com.danby.happynode.data.align.model.dto.FollowUnfollowMqDTO;
...
@Component
@RocketMQMessageListener(consumerGroup = "happynode_group_data_align_" + MQConstants.TOPIC_COUNT_FOLLOWING, // Group 组
