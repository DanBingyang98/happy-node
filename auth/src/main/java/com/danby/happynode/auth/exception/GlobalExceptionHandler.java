...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public Response<Object> businessExceptionHandle(HttpServletRequest req, BusinessException ex) {
    ...
    @ResponseBody
    public Response<Object> methodArgumentExceptionHandle(HttpServletRequest req, MethodArgumentNotValidException ex) {
        // 参数错误异常码
    ...
    @ResponseBody
    public Response<Object> otherExceptionHandle(HttpServletRequest request, Exception e) {
